<?php
	...
	//session
?>
<center><h1>RETURN BOOKS(REQUESTS)</h1>
<?php
	session_start();
	...
	if ($uid == $r["USER_ID"])
	{
		...
		{
			echo "<table border=1><tr><th>STUDENT ID</th><th>ACCCESS NO:</th><th>CHECKOUT ID</th><th>BOOK NAME</th><th>DUE DATE</th><th>ISSUE DATE</th><th>RETURN DATE</th><th>ACTION</th></tr>";
